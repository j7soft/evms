...
<style>
	.request_area .edu_explain{border:none;}
	.request_area .edu_explain img{width:100%;}
</style>
            ...
            <div class="request_area">
               ...
               <!-- <textarea rows="" cols="" id="" name="CONTENT" class="edu_explain" readonly style="width:100%;">${vo.CONTENT }</textarea> -->
                ...
                <div class="">
					...
					<p class="alert">로그인 이후 신청가능합니다.</p>
...
<style>
	.aa{color:red;float:left;}
.input_hr ul li div{width:75%;}
.input_hr ul li h2{margin-left:2px;}
#bb, #ss{width:60%;}
</style>
