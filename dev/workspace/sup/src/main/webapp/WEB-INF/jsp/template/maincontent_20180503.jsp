...
.bx-wrapper .bx-pager.bx-default-pager a:hover, .bx-wrapper .bx-pager.bx-default-pager a.active, .bx-wrapper .bx-pager.bx-default-pager a:focus{background-color:#63b746;}
...
.main_plan .plan_wrap > div .title a.moreNotice{display:inline-block;margin-top:5px;}
.main_plan .plan_wrap > div.notice .title h3{display:inline-block;}
	...
	<section id="section">
		...
		<article class="main_slider">
			...
			<ul class="slider clear">
				...
				<li class="slide active">
					<h3>새활용탐방신청</h3> <a href="/book.do?type=trip"><img src="/img/main/reservation_learning_3.png" alt=""></a>
					<p>정기현장학습(20명이하)<br>
					<!-- <span>설치 및 철거일 동일요금 적용,<br>
					10:00~21:00 사용 기준</span></p> -->
				</li>
				<li class="slide">
					<h3>새활용탐방단체신청</h3> <a class="alltrip"><img src="/img/main/slider_4.png" alt=""></a>
					<p>단체현장학습(20명초과 30명이하)<br>
					<!-- <span>설치 및 철거일 동일요금 적용,<br>
					10:00~21:00 사용 기준</span></p> -->
				</li>
				<li class="slide">
					<h3>셔틀버스</h3><a class="busBtn"><img src="/img/main/slider_5.png" alt=""></a>
					<p>셔틀버스 신청하러가기<br>
					<!-- <span>설치 및 철거일 동일요금 적용,<br>
					10:00~21:00 사용 기준</span></p> -->
				</li>
		...
		<article class="main_plan">
			<div class="plan_wrap clear">
				...
				<div class="notice">
					<div class="title"><h3>공지사항</h3><a class="moreNotice" href="/board.do?type=notice" >더보기</a></div>
				<c:forEach begin="0" end="4" varStatus="i">
					<c:if test="${not empty noticeList[i.index]  }">
						<ul>
							<li class="clear" >
								<span>
									<a href="/detail.do?NTT_ID=${noticeList[i.index].NTT_ID }&BBS_ID=${noticeList[i.index].BBS_ID }">
								 		${noticeList[i.index].TITLE}
								    </a>
								</span>
								<span>${noticeList[i.index].PUSHDATE }</span>
							</li>
						</ul>
					</c:if>
				</c:forEach>
...
<!--				<div class="notice">
	...
	<form name="notice_form1">
		<div id="mainPop">
		 <div class="popup_close"><span>오늘 하루 보지 않기</span><input type="checkbox" name="chkbox1" id="checkedbox" onclick="javascript:closeWin1();">
		 	<div class="rentPopcloseBtnDiv" onclick="javascript:document.getElementById('mainPop').style.display='none';">
		 		<div></div>
				<div></div>
			</div>
		</div>
		    <img src="/img/common/popBG.png" alt="팝업이미지" onclick="location.href='/detail.do?NTT_ID=notice&BBS_ID=1640';">
		</div>
	</form>
	<!-- <form name="notice_form2">	
		
		<div id="mainPop2">
			 <div class="popup_close"><span>오늘 하루 보지 않기</span><input type="checkbox" name="chkbox2" id="checkedbox" onclick="javascript:closeWin2();">
			<div class="rentPopcloseBtnDiv" onclick="javascript:document.getElementById('mainPop2').style.display='none';">
		 		<div></div>
				<div></div>
			</div>
		</div>
		</div>
		<img src="" alt="팝업이미지2" onclick="location.href='';">
	</form> -->
</body>
<style>
	#mainPop, #mainPop2{width:30%;position:fixed;z-index:99999;top:141px;left:0;}
	#mainPop img, #mainPop img{width:100%;cursor:pointer;}
	.popup_close{background:#5a5a5a;padding:0.2% 0;}
	.popup_close span{color:#fff;margin:0 2%;}
	#mainPop .rentPopcloseBtnDiv>div{background:#fff;top:2px;right:15px;}
	...
	<script>
		...
		function closeWin1() {
			if (document.notice_form1.chkbox1.checked) {
				setCookie1("mainPop", "done", 1);
			}
			//document.getElementById("popup").style.visibility = "hidden";
		}
		function closeWin2() {
			if (document.notice_form2.chkbox2.checked) {
				setCookie2("mainPop2", "done", 1);
			}
...
<script type="text/javascript">
    ...
    if (cookiedata1.indexOf("mainPop=done") < 0) {
        document.getElementById("mainPop").style.visibility = "visible";
    } else {
        document.getElementById("mainPop").style.visibility = "hidden";
    }
    if (cookiedata1.indexOf("mainPop2=done") < 0) {
        document.getElementById("mainPop2").style.visibility = "visible";
    } else {
        document.getElementById("mainPop2").style.visibility = "hidden";
    }
</script>