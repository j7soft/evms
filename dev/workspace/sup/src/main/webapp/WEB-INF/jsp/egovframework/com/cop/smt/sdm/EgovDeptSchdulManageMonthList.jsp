	...
	<form name="deptSchdulManageVO" id="deptSchdulManageVO" action=""
		...
		<DIV id="content" style="width: 712px;">
			...
			<div class="sort_area">
				...
				<div class="date_view" style="left: 39%;">
					<ul>
						...
						<li><a class="prev"
							href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageMonthList.do' />?year=<%=year - 1%>&amp;month=<%=month%>">prev</a></li>
						<li class="date"><%=year%> <spring:message
								code="comCopSmtSdm.Navi.Year" /></li>
						<!-- 년 -->
						<li><a class="next"
							href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageMonthList.do' />?year=<%=year + 1%>&amp;month=<%=month%>">next</a></li>
						<li class="date">&nbsp;</li>
						...
						%>
						<li><a
							href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageMonthList.do' />?year=<%=year%>&month=<%=month - 1%>"
							title="이전월으로가기" class="prev">prev</a></li>
						<%
							}
						%>
						...
						<li><a
							href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageMonthList.do' />?year=<%=year%>&month=<%=month + 1%>"
							class="next" title="다음월으로가기">next</a></li>
						<%
							}
						%>
			...
			<table class="month">
				...
				<thead>
					<tr>
						<th><spring:message code="comCopSmtSdm.Monthly.sunday" /></th>
						<!-- 일 -->
						<th><spring:message code="comCopSmtSdm.Monthly.monday" /></th>
						<!-- 월 -->
						<th><spring:message code="comCopSmtSdm.Monthly.tuesday" /></th>
						<!-- 화 -->
						<th><spring:message code="comCopSmtSdm.Monthly.wednesday" /></th>
						<!-- 수 -->
						<th><spring:message code="comCopSmtSdm.Monthly.thursday" /></th>
						<!-- 목 -->
						<th><spring:message code="comCopSmtSdm.Monthly.friday" /></th>
						<!-- 금 -->
						<th><spring:message code="comCopSmtSdm.Monthly.saturday" /></th>
						<!-- 토 -->
					</tr>
				</thead>
				<TBODY>
					<TR>
						<%
							...
							for (int index = 1; index <= endDay; index++) {
								...
								out.println("<a href=\"JavaScript:fn_egov_regist_DeptSchdulManage('" + iUseDate + "');\"><font color='"
										+ color + "'>" + index + "</font></a>");
								out.println("<BR>");
										...
										if (iUseDate >= iBeginDate && iUseDate <= iBeginEnd) {
											...
											if (iSchdulWeekFirest == 1
												...
												out.print("<div class='divWeekBar' style='margin-top:" + (iDayCount * 20)
														...
														+ "px;border:solid 0px;background-color:" + egovMap.get("schdulWeekColor")
														+ ";'><a href=\"JavaScript:fn_egov_detail_DeptSchdulManage('"
								...
								if (newLine == 7) {
									out.println("</TR>");
									out.println(
											"<TR class='line'><td></td><td></td><td></td><td></td><td></td><td></td><td></td></TR>");
									if (index <= endDay) {
										out.println("<TR>");
									}
									newLine = 0;
