 ...
 * 	$.fn.MWslider.addNav = function(that,f1,settings){
	...
	$.fn.MWslider.addNav = function(that,f1,settings){
		var leftArrow=$("<div class='navContainer' id='prev'><div class='"+settings.nav.leftClass+"'></div>").prependTo(that),
			rightArrow=$("<div class='navContainer' id='next'><div class='"+settings.nav.rightClass+"'></div>").appendTo(that);
		leftArrow.on("click",function(){f1(that,"left",settings);});
		rightArrow.on("click",function(){f1(that,"right",settings);});
	}
