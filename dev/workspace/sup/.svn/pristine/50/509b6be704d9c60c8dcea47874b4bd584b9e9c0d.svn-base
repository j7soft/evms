					...
					<div class="input_hr input_hr_2">
							<ul>
								...
								<li>
									<h2>기관</h2>
									<div>
										<input type="text" name="TEAMNAME" id="TEAMNAME" placeholder="기관/단체/회사명">
									</div>
								</li>
								<li>
									<h2>담당부서</h2>
								...
								<li class="radio_box_hr">
									<ul>
										<li>
											...
											<label for="da">개인정보 이용동의 <a><strong style="cursor:pointer;" onclick="javascript:document.getElementById('wrap_agree').style.display='block';">개인정보 이용약관</strong></a></label>
										</li>
									</ul>     
								</li>						
							</ul>
