...
/*
	...
	public boolean searchPassword(LoginVO vo) throws Exception {
		...
		//String enpassword = EgovFileScrty.encryptPassword(newpassword, vo.getId()); 암호화
    	pwVO.setId(vo.getId());
    	pwVO.setPassword(vo.getPassword());
    ...
    @Override
	public LoginVO signOut(LoginVO vo) throws Exception {
	...
	public List<fVO> getCode(String str) {
		List<fVO> list = loginDAO.getCode(str);
		return list;
	}
