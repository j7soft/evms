...
public class LoginDAO extends EgovComAbstractDAO {
    ...
    public LoginVO actionLogin(LoginVO vo) throws Exception {
    	LoginVO lvo = (LoginVO)selectOne("LoginUsr.actionLogin", vo);
    	return lvo;
    }
    ...
    public void deleteUser(LoginVO vo) throws Exception {
    	delete("LoginDAO.deleteUser", vo.getUniqId());
    //	delete("LoginDAO.deleteUser", vo.get());
    }

	public List<fVO> getCode(String str) {
		List<fVO> list= selectList("LoginUsr.getCode",str);
		return (List<fVO>) list;
	}
}
