...
</td><td></td><td></td><td></td><td></td><td></td><td></td></tr></tbody></table></div></div></div></div></td></tr></tbody></table></div></div> -->
...
<p class="alert" style="margin-top: 60px; margin-bottom: 10px;">*신청은 로그인 이후 가능합니다.</p>
				...
				<input type="hidden" id="ITEM" name="ITEM" />
							...
							<!--<li>
								<h2>일자</h2>
									<div>
										<input type="text" name="FDATE" id="FDATE" required placeholder="일자를 기입해 주세요">
									</div>
								</li>-->
								<li>
									<h2>연락처</h2>
								...
								<li>
									<h2>이용시간</h2>
									<div>
										<input type="time" name="FTIME" id="FTIME" class="timeInput" required placeholder="이용시간을 선택하세요">
								</li>
								<li>
									<h2>이용목적</h2>
									<div>
								...
								<li>
									<h2>비상연락처</h2>
									<div>
										<input type="number" name="TEL_SEC" id="TEL_SEC" placeholder="ex) 010-0000-0000">
									</div>
								</li>
								<li>
									<h2>기타요청사항</h2>
