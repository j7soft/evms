...
//String path = "C:/webproj/workspace/egovCommon/src/main/webapp/upload/"; // 이미지가 저장될 주소 로컬
String path = request.getSession().getServletContext().getRealPath("/") + File.separator + "/upload"; // 이미지가 저장될 주소 운영
String filename = "";
