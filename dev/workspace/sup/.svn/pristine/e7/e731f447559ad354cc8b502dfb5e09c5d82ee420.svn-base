...
function initialize() {
			...
			/*
				...
				37.581861,126.9850333
			*/
			var Y_point			= 37.558567;		// Y 좌표
			var X_point			= 127.0581139;		// X 좌표

			var zoomLevel		= 15;						// 첫 로딩시 보일 지도의 확대 레벨

			var markerTitle		= "서울새활용플라자";				// 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
			...
			var contentString	= '<div id="content">' +
					...
					'<div id="bodyContent">'+ 
						'<p>서울새활용플라자 <br /><a href="http://www.seoulup.or.kr/" target="_blank"></a></p>'+	
					'</div>'+ 
				'</div>';
